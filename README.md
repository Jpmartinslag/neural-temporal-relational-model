...
| Observatory v0.5.1 | **Candidat actuel — meilleur brouillon** (`herald_observatory_v051_narrative_dashboard.html`) — décision `OBSERVATORY_V051_CANDIDATE_NEEDS_MAP_REDESIGN` (103/103 tests structurels passent, mais **jamais validé visuellement** — pas de Playwright/capture d'écran réelle — et le product owner a déjà demandé une refonte modulaire en partant de la carte ; ce n'est donc pas un livrable final accepté). **Non encore committé en git** | DEC-068 |
