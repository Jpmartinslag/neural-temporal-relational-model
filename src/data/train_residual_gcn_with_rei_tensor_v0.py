...
METRICS_OUT = ROOT / "reports" / "residual_gcn_with_rei_tensor_metrics_v0.json"
REPORT_OUT = ROOT / "reports" / "RESIDUAL_GCN_WITH_REI_TENSOR_V0.md"
PRED_OUT = ROOT / "data" / "processed" / "residual_gcn_with_rei_tensor_predictions_v0.csv"
...
def main():
    ...
    payload = {
        ...
        "model": "residual_gcn_with_rei_tensor_geo",
    ...
    lines = [
        "# Residual GCN With REI Tensor v0",
        "",
