...
| F-03 | Pooled (4-country balanced) WMAPE: persistence ~0.0939, Ridge ~0.0969 | Phase 4N harmonized + Phase 4G-4I broader LOCO | 4N/4H-B | PT/IT/AT or FR/NL/BE/PT | Rolling-origin LOCO | `HERALD_PHASE4N_RESULTS_AUDIT.md`; `HERALD_PHASE4H_B_RESULTS_AUDIT.md` | Moderate | Protocol-specific | 1-year horizon; 3–4 country domains not sufficient for universal claim | `SUPPORTED` |
...
| G-07 | Economic dynamic graph (sector-territory relations) improves forecasting or interpretation | Not yet run | — | — | — | — | None | — | Not yet designed | `NOT_TESTED` |
| G-08 | Functional/mobility network provides predictive signal for enterprise births | Not yet run | — | — | — | — | None | — | Data availability not confirmed at NUTS3 level | `NOT_TESTED` |
...
| REC-02 | Dynamic economic graph identifies productive opportunities for territories | Not yet run | — | — | — | — | None | — | Graph not yet defined or built | `NOT_TESTED` |
