...
| G-13 | The L2 top-k=5 co-growth graph shows temporal coherence (observed LOYO Jaccard exceeds temporal-permutation null) across all country × sector combinations | G2 preflight — temporal dynamics + negative control | Bloco 2 / G2 | FR/NL/PT; 2012-2026 (sector-dependent); top-k=5; COVID year excluded from windows | LOYO Pearson and Jaccard; consecutive year turnover; persistence fraction; top-k sensitivity; 199-permutation temporal null; BH/FDR q=0.05 | `HERALD_G2_PREFLIGHT.md` | Yes: 26/26 country×sector FDR-significant (p=0.005); all positive effects; 3/3 countries pass gate. Effect relative: FR +23-40%, NL +18-81%, PT +12-30%. LOYO Jaccard 0.07-0.26 (fail ≥0.70 stability threshold). Persistence 0.4%, turnover 59%. COVID: no disruption above thresholds. | FR 280 regions → small absolute Jaccard despite significance; PT with 25 regions has larger null (~0.21); sensitivity consistent k=3,5,10 | Signal is statistically genuine (not finite-sample artefact) but graph remains highly dynamic in absolute terms; individual edge claims remain NOT authorised | `SUPPORTED` |
