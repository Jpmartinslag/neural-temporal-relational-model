...
`reports/HERALD_EVIDENCE_MATRIX.md`, and `reports/HERALD_PROJECT_CHARTER.md` §4-5. If this
document disagrees with any of those, they win. No DEC-* is changed, renumbered, or
reinterpreted here.
