...
| PT Municipal Phase 7 | DEC-064 (2026-06-16) | Does PT municipal grain yield valid relations? | PT, 278 municipalities (`PT_MUNICIPALITY_CONTINENTE`) | Signed lag-1 regression, full scale | 10/10 gates | 2 COVID-robust pairs (2015-2020 only) | **VALID** | #2, #4, #6 | Article: yes, period-specific |
