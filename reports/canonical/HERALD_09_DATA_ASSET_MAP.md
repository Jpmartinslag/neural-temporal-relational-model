...
| `data/processed/france_ze2020/fr_ze2020_dynamic_graph_edges_pruned_stable.csv.gz`, `fr_ze2020_dynamic_graph_edges_stateful*.csv.gz`, `fr_ze2020_dynamic_graph_edges_feature_compatible*.csv.gz`, `fr_ze2020_dynamic_graph_edges_learned*.csv.gz`, `fr_ze2020_dynamic_graph_edges_precision*.csv.gz` | FR ZE2020, HERALD_26 edge variants | Edge-variant bundle for falsifying graph structure hypotheses: pruned-stable, stateful, sector-only, top-k, sector-top-k, feature-compatible, rolling learned-edge gates, and rolling historical-precision gates. HPC run `fr_ze2020_dynamic_edge_variants_20260702_121925` found sector-only MLP gains versus `no_edges`, but not robust versus `random_edge_weights`; precision variants are follow-up falsification inputs only, not model promotion. Registry `FR_ZE2020_DYNAMIC_EDGE_VARIANTS_V1` |
