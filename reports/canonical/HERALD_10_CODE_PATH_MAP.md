...
| `src/data/france_ze2020/build_fr_ze2020_dynamic_edge_variants.py` | HERALD_26 edge variant builder: `fr_ze2020_dynamic_graph_edges_pruned_stable.csv.gz`, `fr_ze2020_dynamic_graph_edges_stateful.csv.gz` | New 2026-07-02, see `HERALD_26_FR_ZE2020_EDGE_LEARNING_PLAN.md` -- edge construction only, local smoke only, no HPC promotion, no recommendation, no causal claim |
