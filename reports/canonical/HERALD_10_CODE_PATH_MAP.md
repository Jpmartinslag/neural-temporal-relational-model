...
| `src/modeles/france_ze2020/run_fr_ze2020_commuting_relation_gate.py` | Builds incoming/outgoing neighbour-sector profiles from strict ex-ante commuting matrices and evaluates them with the fixed ZE-disjoint linear transition protocol against semantic and random placebos | New 2026-07-22, DEC-074 / HERALD_45. Pre-registered, not yet run; no neural encoder |
