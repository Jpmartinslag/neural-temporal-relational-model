...
| `src/modeles/france_ze2020/run_fr_ze2020_composition_transition_ranking_gate.py` | DEC-080 held-out-ZE ranking of next-year sector-share transition magnitude and direction from observed current/lagged compositions, with own-history, Ridge, information-ablation, sector/time/target-shuffle, and random controls | HERALD_54 pre-registered transition-representation diagnostic; no inferred edges, dynamic-GNN claim, or recommendation logic |
