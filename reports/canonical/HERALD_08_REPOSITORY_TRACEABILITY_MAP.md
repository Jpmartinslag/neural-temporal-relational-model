...
| `docs/` (`docs/architecture/`) | Older architecture diagrams (LikeC4 etc.) | Historical | No one starting fresh | The current architecture — use `reports/canonical/HERALD_03_METHODS_AND_ARCHITECTURE.md` instead |
