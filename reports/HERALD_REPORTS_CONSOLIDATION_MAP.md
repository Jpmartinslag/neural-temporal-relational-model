...
In addition to the cluster-level mapping above, seven second-level documents now exist
...
| Every data path classified (canonical/valid/raw/historical/blocked) | `reports/canonical/HERALD_09_DATA_ASSET_MAP.md` |
| Every `src/` module classified (active/historical/closed/research) | `reports/canonical/HERALD_10_CODE_PATH_MAP.md` |
