#!/bin/bash
# HERALD Phase 2G anti-noise battery — safe preflight + submit.
set -euo pipefail

STAMP=${STAMP:-$(date +%Y%m%d_%H%M%S)}
OUT_ROOT=${OUT_ROOT:-"hpc_results/herald_regime_phase2g_feature_noise_${STAMP}_r1"}
SEEDS=${SEEDS:-"0 1 7 13 17 42 77 99 123 2025"}
EPOCHS=${EPOCHS:-800}
MASK_WARMUP=${MASK_WARMUP:-100}
MAX_PARALLEL=${MAX_PARALLEL:-10}
DEVICE=${DEVICE:-}
REGIME_PLAN="phase2g_feature_noise"
...
echo "========================================================"
echo " HERALD Phase 2G — Feature-noise Preflight + Submit"
