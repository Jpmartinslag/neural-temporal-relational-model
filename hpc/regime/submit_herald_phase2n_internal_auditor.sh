#!/bin/bash
# HERALD Phase 2N internal auditor — safe preflight + submit.
set -euo pipefail

STAMP=${STAMP:-$(date +%Y%m%d_%H%M%S)}
REGIME_PLAN=phase2n_internal_auditor
OUT_ROOT=${OUT_ROOT:-"hpc_results/herald_regime_phase2n_internal_auditor_${STAMP}_r1"}
...
echo "========================================================"
echo " HERALD Phase 2N — internal auditor"
...
bash -n hpc/regime/submit_herald_phase2n_internal_auditor.sh
bash -n hpc/regime/smoke_test_phase2n_internal_auditor.sh
echo "bash -n OK"
...
echo ""
echo "Audit:"
echo "  python3 hpc/regime/audit_herald_phase2n_internal_auditor.py --root ${OUT_ROOT} --strict"
