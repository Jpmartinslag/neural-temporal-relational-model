#!/bin/bash
# HERALD Phase 2M latent auto-regulation audit — safe preflight + submit.
set -euo pipefail

STAMP=${STAMP:-$(date +%Y%m%d_%H%M%S)}
REGIME_PLAN=phase2m_latent_autoreg_strong
OUT_ROOT=${OUT_ROOT:-"hpc_results/herald_regime_phase2m_latent_autoreg_${STAMP}_r1"}
...
echo "========================================================"
echo " HERALD Phase 2M — latent auto-regulation"
...
bash -n hpc/regime/submit_herald_phase2m_latent_autoreg.sh
bash -n hpc/regime/smoke_test_phase2m_latent_autoreg.sh
echo "bash -n OK"
