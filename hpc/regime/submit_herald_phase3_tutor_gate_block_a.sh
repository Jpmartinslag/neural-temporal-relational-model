#!/bin/bash
# HERALD Phase 3 Tutor Block A — conditional-gate battery.
set -euo pipefail

STAMP=${STAMP:-$(date +%Y%m%d_%H%M%S)}
REGIME_PLAN=phase3_tutor_gate_block_a
OUT_ROOT=${OUT_ROOT:-"hpc_results/herald_regime_phase3_tutor_gate_block_a_${STAMP}_r1"}
