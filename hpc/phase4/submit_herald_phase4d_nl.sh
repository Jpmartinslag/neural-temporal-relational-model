#!/bin/bash
# Submit HERALD Phase 4D — NL battery (functional graphs: commuting + sector similarity).
...
echo ""
echo "============================================================"
echo " Phase 4D — NL Battery (functional graphs)"
...
echo ""
echo "============================================================"
echo " Phase 4D NL submitted"
echo " Job ID  : ${JOB_ID}"
echo " OUT_ROOT: ${OUT_ROOT}"
echo " Seeds   : $((ARRAY_MAX + 1)) tasks  (array 0-${ARRAY_MAX}%${MAX_PARALLEL})"
echo ""
echo " Audit quando terminar:"
echo "   python3 hpc/phase4/audit_phase4d_results.py --root ${OUT_ROOT} --phase4a-wmape 0.058184 --phase4c-wmape 0.060751"
echo "============================================================"
