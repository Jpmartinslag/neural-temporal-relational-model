#!/bin/bash
# Submit HERALD Phase 4D — PT battery (sector similarity only; commuting blocked).
# 7 configs × 20 seeds = 140 runs
# NOTE: PT uses sector_births tensor (births proxy, NOT Q7 effectifs).
set -euo pipefail
...
echo ""
echo "============================================================"
echo " Phase 4D — PT Battery (sector similarity, births proxy)"
echo " out_root : $OUT_ROOT"
echo " configs  : $n_configs"
echo " seeds    : $n_seeds  ($SEEDS)"
echo " runs     : $expected_runs"
echo " epochs   : $EPOCHS"
echo " WARNING  : PT tensor = sector_births proxy (NOT Q7 effectifs)"
echo "============================================================"
echo ""
...
echo ""
echo "============================================================"
echo " Phase 4D PT submitted"
echo " Job ID  : ${JOB_ID}"
echo " OUT_ROOT: ${OUT_ROOT}"
echo " Seeds   : $((ARRAY_MAX + 1)) tasks  (array 0-${ARRAY_MAX}%${MAX_PARALLEL})"
echo ""
echo " Audit quando terminar:"
echo "   python3 hpc/phase4/audit_phase4d_results.py --root ${OUT_ROOT} --phase4a-wmape 0.169902 --phase4c-wmape 0.170279"
echo "============================================================"
