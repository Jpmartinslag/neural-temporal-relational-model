...
#
# Usage:
#   COUNTRY=nl source hpc/phase4/phase4_configs.sh && phase4_configs
#   COUNTRY=be source hpc/phase4/phase4_configs.sh && phase4_configs
#   COUNTRY=pt source hpc/phase4/phase4_configs.sh && phase4_configs
