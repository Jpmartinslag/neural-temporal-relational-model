#!/bin/bash
# Run one HERALD Phase 4C — seed for one country (all configs sequentially).
#
# Required env vars:
#   SEED      — integer seed
#   COUNTRY   — nl | be | pt
...
run_config() {
  ...
  local tag="phase4c_${COUNTRY}_${label}"
...
echo "============================================================"
echo " HERALD Phase 4C — — ${COUNTRY^^} seed battery"
...
# shellcheck source=phase4c_configs.sh
source "$(dirname "$0")/phase4c_configs.sh"
