#!/bin/bash
# CPU smoke test — HERALD Phase 4 Pays-Bas.
...
OUT_SMOKE=${OUT_SMOKE:-"hpc_results/herald_phase4_nl_smoke_${STAMP}"}
...
bash -n hpc/phase4/submit_herald_phase4_nl.sh
...
"$PYTHON" hpc/phase4/prepare_phase4_panel.py --country nl
