#!/bin/bash
# HERALD -- submit France ZE2020 top-3 entry relation-lift HPC batch.
...
OUTDIR="hpc_results/fr_ze2020_top3_entry_lift_${RUN_ID}"
LOGDIR="${OUTDIR}/logs"

echo "=========================================="
echo "France ZE2020 top-3 entry relation-lift HPC -- RUN_ID=${RUN_ID}"
echo "=========================================="

required_files=(
  hpc/france_ze2020_top3_entry_lift/run_fr_ze2020_top3_entry_lift_task.sh
  hpc/france_ze2020_top3_entry_lift/run_fr_ze2020_top3_entry_lift_array.sbatch
  hpc/france_ze2020_top3_entry_lift/audit_fr_ze2020_top3_entry_lift_hpc_results.py
