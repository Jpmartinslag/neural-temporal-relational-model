# HERALD Codex Memory
**LEIA PRIMEIRO.** Updated 2026-06-16 (DEC-060 COMPLETE — AUDIT_COMPLETE 10/10 PASS. FR tem 1 label Phase 7 pois o critério vinculante é |β| ≥ 0.10 (não FDR). 8 pares near-miss-beta: passam FDR+Δr²+bss mas |β|=0.076-0.097. MN→BE o par mais consistente (6 janelas p≤0.01) mas anti-correlação beta-FDR impede promoção. RU→MN classificado FR_COVID_SENSITIVE (p_perm pre-COVID=0.127). 63 testes PASS. Outputs em data/processed/france_relation_audit/.).
