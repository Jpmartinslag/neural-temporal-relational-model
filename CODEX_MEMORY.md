# HERALD Codex Memory
**LEIA PRIMEIRO.** Updated 2026-06-12 (DEC-033: sector precedence builder implemented; full run pending user execution).
...
- **Immediate next step:** execute the frozen DEC-033 sector precedence run, then audit outputs. No GNN; no structural-causality claim.
