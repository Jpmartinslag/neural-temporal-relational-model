# HERALD Codex Memory
**LEIA PRIMEIRO.** Updated 2026-06-12 (DEC-032: Observatory aggregate v0.1.1 and sector v0.2 built; sector→sector layer is next).
...
- **Observatory exports:** aggregate PT/IT/AT v0.1.1 (1,963 rows) and sector FR/NL/PT v0.2 (45,945 rows) are generated by `src/data/european_panel/build_observatory_export.py`.
- **Immediate next step:** implement and audit a signed, lagged sector→sector association layer. No GNN; no structural-causality claim.
