# HERALD Codex Memory
**LEIA PRIMEIRO.** Updated 2026-06-16 (DEC-059 COMPLETE — 8/10 PASS. REAL_WEAK_LABEL_TUNING_PARTIAL. V1 LOCO sign concordance=0.500 (valid folds NL+PT; FR=LOW_EVIDENCE n=1). M2 FAIL: C1/C2/C3/C5 within 0.021 of V1=0.667. M4 FAIL: 0 abstentions. 49/49 testes PASS. DEC-058 corrigido para PARTIAL.).
