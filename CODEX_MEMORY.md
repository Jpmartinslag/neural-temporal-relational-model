# HERALD Codex Memory
**LEIA PRIMEIRO.** Updated 2026-06-13 (DEC-047: few-shot adaptation benchmark PILOT_COMPLETE. Decision: FEWSHOT_ADAPTATION_FAILED — ffill domina todos os neurais; gap distribuição demasiado largo para fine-tuning sem pretraining. Próximo: DEC-048 masked pretraining PATH 2).
