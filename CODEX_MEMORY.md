# HERALD Codex Memory
**LEIA PRIMEIRO.** Updated 2026-06-15 (DEC-054 COMPLETE — 8/10 PASS. U2/U3 FAIL. Confound crítico: P0 permutado tem mesmo AUROC=0.599 que G1/G2 → melhoria não é de utility learning. G3 oracle confirma grafo útil: MAE −9.1%. 71/71 testes PASS).
