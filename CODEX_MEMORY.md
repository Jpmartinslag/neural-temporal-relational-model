# HERALD Codex Memory
**LEIA PRIMEIRO.** Updated 2026-06-16 (DEC-058 COMPLETE — 8/10 PASS. REAL_WEAK_LABEL_TUNING_SUPPORTED. V1 LOCO sign concordance=0.667 vs V0=0.313 vs DEC-056 baseline=0.438. W3 PASS (≥0.50). W4 PASS (58 replicated pairs). W2 FAIL (controls C1=0.646/C2=0.688 ≥ V1=0.667; 12 labels too sparse). W6 FAIL (0% abstention). 60/60 testes PASS. Checkpoint inicial=39b30a52da2ad330 → final=254c6efe61f94d49.).
