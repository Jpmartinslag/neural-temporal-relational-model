# HERALD Codex Memory
**LEIA PRIMEIRO.** Updated 2026-06-16 (DEC-056 CORRECTED — 7/10 PASS. REAL_SHARED_RELATION_PARTIAL. Checkpoint treinado hash=39b30a52da2ad330 (DEC-055 best_seed=30, OOS-AUC=0.752). Presence mean=0.648, 829/1096 acima threshold 0.55. R2 PASS: sector permutation degrada -0.178. R3 PASS: stability FR=0.820/NL=0.412/PT=0.593. R4 FAIL: concordância Phase 7 =0.438 < 0.50. R5/R6 FAIL: 194 COVID_SENSITIVE, sem replicação cross-country. 77/77 testes PASS. Run anterior INVÁLIDA (encoder não treinado).).
